...
public class SebalPropertiesConstants {
	...
	public static final String EXPERIMENTO_FEDERATION_MEMBER = "experimento.manager.naf.lsd.ufcg.edu.br";
	...
	public static final String EXPERIMENTO_FTP_SERVER_USER = "experimento_ftp_server_user";	
	public static final String EXPERIMENTO_FTP_SERVER_PORT = "experimento_ftp_server_port";
